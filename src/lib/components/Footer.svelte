...
<footer class="bg-emerald-950 pt-16 pb-10 text-emerald-50">
	<div class="mx-auto max-w-5xl px-6 lg:px-12">
		...
		<div class="grid grid-cols-1 gap-12 md:grid-cols-[2fr_1fr_1fr]">
			...
			<!-- Links -->
			<div>
				<p class="mb-4 font-mono text-[0.65rem] tracking-[0.18em] text-emerald-500 uppercase">
					Navigate
				</p>
				<ul class="space-y-3">
					<li>
						<a href="/" class="text-sm text-emerald-200/60 transition-colors hover:text-white"
							>Home</a
						>
					</li>
					<li>
						<a href="/signup" class="text-sm text-emerald-200/60 transition-colors hover:text-white"
							>Apply for Membership</a
						>
					</li>
					<li>
						<a href="/login" class="text-sm text-emerald-200/60 transition-colors hover:text-white"
							>Member Dashboard</a
						>
					</li>
					<li>
						<a href="/about" class="text-sm text-emerald-200/60 transition-colors hover:text-white"
							>About</a
						>
					</li>
				</ul>
		...
		<div class="mt-6 flex flex-col gap-3 md:flex-row md:items-center md:justify-between">
			...
			<div class="flex gap-6">
				<a
					href="/privacy"
					class="font-mono text-[0.65rem] text-emerald-600 transition-colors hover:text-emerald-400"
					>Privacy</a
				>
				<a
					href="/terms"
